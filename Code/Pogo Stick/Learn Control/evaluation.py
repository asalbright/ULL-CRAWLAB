...
from functions import getFiles, getFileNames, readCSVFiles, parseDataFrame, getDirectoryPath, combineDataInFolder, dfAverageStd, guiYesNo

from gym_pogo_stick.gym_pogo_stick.envs import PogoStickControlEnv

REWARD_FUNCTIONS = ["Height", "Efficiency", "SpecHei", "SpHeEf"]
JUMP_TYPES = {"OneJump": 1, "StutterJump": 2}
PLOT_DATA = True
SAVE_FIG = True
SHOW_FIG = False
