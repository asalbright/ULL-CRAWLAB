...
class PogoStickDesignEnv(gym.Env):
    ...
    def _calc_reward(self, timeseries):
    ...
    def _eval_design(self, params=None):
        ...
        # Set the env
        eval_env = PogoStickControlEnv(numJumps=2,
                                       linear=ENV_TYPE,
                                       epSteps=EP_STEPS, 
                                       evaluating=True,
                                       rewardType=self.reward_function,
                                       captureData=False, 
                                       saveDataName=None,
        ...
        if not params is None:
            eval_env.pogo_stick.modify_design(params=params)
        ...
        while not done:
            ...
            self.state[:,eval_env.timestep-1] = obs
