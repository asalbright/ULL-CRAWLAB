...
class PogoStick:
    ...
    def modify_design(self, params=None, percent_change=0.30):
    ...
    def get_params(self):
        return {"k": self.k, "zeta": self.zeta}

    def reset_state(self, evaluating=False, mod_params=False, params=None):
        if evaluating: 
