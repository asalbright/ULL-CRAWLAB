...
def train_agents(seed=12345):
    ...
    for REWARD_FUNCTION in REWARD_FUNCTIONS:
        ...
        learn_design_cb = TrainingDesignCallback(train_freq=UPDATE_MECH_PARAMS, 
        ...
        model.learn(total_timesteps=N_TRAINING_STEPS, 
                    callback=callbacks,
                    tb_log_name=f'ctr_{data_name}_{int(seed)}')
