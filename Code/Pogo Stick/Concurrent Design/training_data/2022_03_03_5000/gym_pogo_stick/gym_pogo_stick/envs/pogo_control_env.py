...
class PogoStickControlEnv(gym.Env):
    ...
    def __init__(self, 
        ...
        self.mod_params = modParams              # train robust agent by varying parameters during training
        self.params = None
    ...
    def step(self, action):
        ...
        reward = self._calc_reward(self.state, self.reward_type)
    ...
    def _calc_reward(self, state, rewardType):
    ...
    def reset(self):
        ...
        self.state = self.pogo_stick.reset_state(self.evaluating, self.mod_params, self.params)
        # Reset the done flag
        self.done = False
