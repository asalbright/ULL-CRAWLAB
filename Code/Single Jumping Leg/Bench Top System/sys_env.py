...
class SingleLegCtrlEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.leg = SingleJumpingLeg(max_motor_vel=self.motor_max_vel, 
    ...
    def get_camera_image(self, xres=640, yres=480):
        # TODO: Get the camera image
        frame = self.leg.get_camera_image(xres=xres, yres=yres)
